...
function notificacion(){
	$.post("include/buscar_notificacion.php", function(data){
		if (data > "0"){
			$('#burbuja').fadeIn(1000).html(data);
		}else{
			$('#burbuja').fadeOut();
		}
	});//End post
...
natDays = [
			  [1, 1, 'Año Nuevo'],[2,8,'Lunes Carnaval'],[2,9,'Martes Carnaval'],
			  [3,24, 'Jueves Santo'], [3,25,'Viernes Santo'],
			  [4,19,'Declaración de independiencia'],[5,1, 'Día del trabajador'],			  
			  [6, 24, 'Batalla Carabobo'], [7, 5, 'Independencia'], [7, 24, 'Natalicio Libertador'],
			  [10, 12, 'Dia de la Raza'], [12,24, 'Noche Buena'], [12, 25, 'Navidad'],[12, 31, 'Fin de año']
		  ];
